...
<h1 id="textcolor">Here You Can Know The Nationality Of The Name</h1><br>
<input type="text" id="searchtext" placeholder=" Enter the name" size="50">
<input type="button" value="Search" id="btn" class="btn btn-light">
<input type="button" value="Reset" id="resetbtn" class="btn btn-danger">
</div>
<div class=" container-fluid result">
<h4 id="text"> Name Related Top Two Countries And Their Probabilities Are</h4><br>
<h4 id=result></h4
</div>`
